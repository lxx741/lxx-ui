...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.lxx-collapse-item__header')
    contents = wrapper.findAll('.lxx-collapse-item__wapper')
  ...
  test('手风琴模式 错误处理', () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [LxxUIError: [LxxCollapse]:accordion mode should only have one active item],
          ],
        ]
      `
    )
